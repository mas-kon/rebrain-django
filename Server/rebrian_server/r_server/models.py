...
class Client(models.Model):
    ...
    load_average_1min = models.IntegerField('load average 1min')
    load_average_5min = models.IntegerField('load average 5min')
    load_average_15min = models.IntegerField('load average 15min')
